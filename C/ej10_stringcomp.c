/*
Escribir un programa que lea dos cadenas de caracteres, y muestre sus longitudes, compare
si son iguales, concatene en la primera la segunda y luego copie la primera en la segunda.
*/
