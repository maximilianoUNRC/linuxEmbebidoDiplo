/*
Escribir un programa que lea un vector y una matriz y escriba el producto de los mismos. La
lectura del vector y la matriz y el producto de los mismos debe realizarse en funciones
separadas.
*/
